                ...
                <div className="main-box"> {/* Uses shared class */}
                    ...
                    {/* Uses shared class */}
                        ...
                        <div className="campus-images-container">
                            <img src="../Images/campus-life-Crkero7B.jpg" alt="Vivekanand College Information" className="campus-image"/>
                            <img src="../Images/students-studying-DbLGuwF_.jpg" alt="Vivekanand College Campus" className="campus-image"/>
                        </div>
                    </div>
                </div>
            </div>
